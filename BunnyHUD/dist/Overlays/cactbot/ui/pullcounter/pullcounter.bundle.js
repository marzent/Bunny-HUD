...
const bossFightTriggers = [{
  ...
  startRegex: {
    en: regexes/* default.gameLog */.Z.gameLog({
      line: 'You bow courteously to the striking dummy.*?'
    }),
    de: regexes/* default.gameLog */.Z.gameLog({
      line: 'Du verbeugst dich hochachtungsvoll vor der Trainingspuppe.*?'
    }),
    fr: regexes/* default.gameLog */.Z.gameLog({
      line: 'Vous vous inclinez devant le mannequin d\'entraînement.*?'
    }),
    ja: regexes/* default.gameLog */.Z.gameLog({
      line: '.*は木人にお辞儀した.*?'
    }),
    cn: regexes/* default.gameLog */.Z.gameLog({
      line: '.*恭敬地对木人行礼.*?'
    }),
    ko: regexes/* default.gameLog */.Z.gameLog({
  ...
  // 23F4 Dualcast
  startRegex: {
    en: regexes/* default.ability */.Z.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    de: regexes/* default.ability */.Z.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    fr: regexes/* default.ability */.Z.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    ja: regexes/* default.ability */.Z.ability({
      source: 'エクスデス',
      id: '23F4'
    }),
    cn: regexes/* default.ability */.Z.ability({
      source: '艾克斯迪司',
      id: '23F4'
    }),
    ko: regexes/* default.ability */.Z.ability({
      source: '엑스데스',
      id: '23F4'
    })
  },
  ...
  startRegex: {
    en: regexes/* default.startsUsing */.Z.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    de: regexes/* default.startsUsing */.Z.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    fr: regexes/* default.startsUsing */.Z.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    ja: regexes/* default.startsUsing */.Z.startsUsing({
      source: 'ケフカ',
      id: '28C2'
    }),
    cn: regexes/* default.startsUsing */.Z.startsUsing({
      source: '凯夫卡',
      id: '28C2'
    }),
    ko: regexes/* default.startsUsing */.Z.startsUsing({
      source: '케프카',
      id: '28C2'
    })
  },
